...
for i in range(0, len(grabbed_files) - len(grabbed_files)%3, 3):
    imgs = []
    for k in range(3):
    ...
    print(f'Working on images {names[0]}, {names[1]} and {names[2]}.')
...
>>>>>>> 9ac028de86755e3cfbd3b31218d799f31ac79b6e
    ...
    frames = [aligned0, aligned1, aligned2, aligned1]

    gif_dest = f'{dest_folder_gifs}/{int(i/3)}.gif'
    vid_dest = f'{dest_folder_vids}/{int(i/3)}.mp4'
    smoothed_vid_dest = f'{dest_folder_vids}/{int(i/3)}-smooth.mp4'
